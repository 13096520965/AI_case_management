    ...
    <el-card class="action-card">
      <el-form :inline="true">
        <el-form-item label="文书类型">
          <el-select v-model="filterType" placeholder="全部类型" clearable style="width: 180px" @change="loadTemplates">
...
const loadTemplates = async () => {
  loading.value = true
  try {
    const params = filterType.value ? { documentType: filterType.value } : undefined
