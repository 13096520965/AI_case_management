...
const fileFilter = (req, file, cb) => {
  ...
  if (allowedMimes.includes(file.mimetype)) {
    ...
    cb(new Error(`不支持的文件类型: ${file.mimetype}。支持 PDF、Word、Excel、文本、图片、音频、视频格式。`), false);
  }
};
